...
Andando a risolvere numericamente il sistema e tracciando le soluzioni otteniamo la  Figura~\ref{fig::3nodicut}. Possiamo notare, come previsto dalla teoria, che  che tali grafici sono identici a quelli ottenuti nel modello esteso ~\ref{fig::spe3nodi}. Inoltre, se andiamo a calcolare l'errore assoluto tra le soluzioni (Figura~\ref{fig::errori3nodi}) otteniamo che tali errori sono dell'ordine della tolleranza dell'integratore.
\begin{figure}[!htb]
\centering
\subfloat[][Nodo 1.]
	{\resizebox{0.45\textwidth}{!}{\input{Figure/Cut_Nodo1}}}
 \quad 
\subfloat[][Nodo 2.]
{\resizebox{0.45\textwidth}{!}{ \input{Figure/Cut_Nodo2}}}
\\
\subfloat[][Nodo 3.]
{\resizebox{0.45\textwidth}{!}
{\input{Figure/Cut_Nodo3}}
}
\quad 
\subfloat[][Prevalenza.]
{\resizebox{0.45\textwidth}{!}{ \input{Figure/Prevalenza}}}
\\
...
\begin{figure}[!htb]
	\centering
	\subfloat[][Nodo 1.]
	{\resizebox{0.45\textwidth}{!}{\input{Figure/Errore1}}}
 \quad 
\subfloat[][Nodo 2.]
{\resizebox{0.45\textwidth}{!}{ \input{Figure/Errore2}}}
\\
\subfloat[][Nodo 3.]
{\resizebox{0.45\textwidth}{!}
{\input{Figure/Errore3}}}
\caption[Errori assoluti relativi al grafo~\ref{fig::3nodi}] {Errore assoluto tra la soluzione del problema di Cauchy~\eqref{3nodi} e quello ottenuto utilizzando il Teorema~\ref{th_cut-vertex}.\\
