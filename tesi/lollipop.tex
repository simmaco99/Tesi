...
\begin{figure}
	\centering
\subfloat[][Nodo 1]{\input{Figure/Lollipop_Nodo1}}
\subfloat[][Nodo 2]{\input{Figure/Lollipop_Nodo2}}
\\
\subfloat[][Nodo 3]{\input{Figure/Lollipop_Nodo3}}
\subfloat[][Nodo 4]{\input{Figure/Lollipop_Nodo4}}
...
\begin{figure}[!htb]
\centering
\subfloat[][Nodo 1]{\input{Figure/Lollipop_Errore1}}
\subfloat[][Nodo 2]{ \input{Figure/Lollipop_Errore2}}
\\
\subfloat[][Nodo 3]{\input{Figure/Lollipop_Errore3}}
\subfloat[][Nodo 4]{\input{Figure/Lollipop_Errore4}}
...
\begin{figure}[!htb]
\subfloat[][Nodo 1]{\input{Figure/Pair_Lollipop_Errore1}}
\subfloat[][Nodo 2]{\input{Figure/Pair_Lollipop_Errore2}}
\\
\subfloat[][Nodo 3]{\input{Figure/Pair_Lollipop_Errore3}}
\subfloat[][Nodo 4]{\input{Figure/Pair_Lollipop_Errore4}}
